...
export const coursesCard = [
  {
    ...
    data: "Khóa Luyện thi vào 10 môn Ngữ văn (HM10 Tổng ôn) do thầy Đặng Ngọc Khương giảng dạy giúp học sinh móc nối, hệ thống, sơ đồ hóa kiến thức, đối chiếu so sánh giữa các tác phẩm để học sinh có cái nhìn tổng quát và đa chiều bám sát định hướng thi vào 10 không chuyên của các tỉnh, thành phố trên cả nước.Tham gia khóa học ngay từ bây giờ và chinh phục ước muốn học tập tạp ngôi trường THPT mong muốn, em nhé!",
  },
  {
    id: 2,
    cover: "../images/courses/c1.png",
